...
export function TransactionFilters({
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-slate-200 bg-white">
      <div className="flex flex-col gap-3 border-b border-slate-100 p-4 min-[420px]:flex-row min-[420px]:items-center min-[420px]:justify-between">
            ...
            <div className="grid grid-cols-3 gap-2">
              {(['all', 'income', 'expense'] as const).map((type) => (
                <button
                  ...
                  className={`rounded-lg px-2 py-2 text-sm font-medium transition-colors sm:px-4 ${
